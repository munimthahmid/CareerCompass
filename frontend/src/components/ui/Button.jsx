function Button({ children, onClick, type }) {
  const baseClasses =
    "text-inherit uppercase py-4 px-8 font-inherit text-lg border-none rounded-lg cursor-pointer";
  const primaryClasses =
    "font-bold  bg-teal-500 hover:bg-black  active:bg-black text-var-color-dark--1";
